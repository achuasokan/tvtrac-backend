...
export class TrackingController {
  ...
  public toggleWatchedStatus = async (req: Request, res: Response) => {
    try {
      ...
      const result = await this.trackingService.toggleWatchedStatus(userId, tmdbId, mediaType);
      res.json(result);
    } catch (error: any) {
  ...
  public toggleEpisodeWatched = async (req: Request, res: Response) => {
    try {
      ...
      const result = await this.trackingService.toggleEpisode(userId, tmdbId, Number(season), Number(episode));
      res.json(result);
    } catch (error: any) {
  ...
  public markSeasonWatched = async (req: Request, res: Response) => {
    try {
      ...
      const result = await this.trackingService.markSeasonWatched(userId, tmdbId, Number(season), episodes.map(Number));
      res.json(result);
    } catch (error: any) {
